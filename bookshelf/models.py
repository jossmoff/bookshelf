...
class Story:
    ...
    def to_renderable(self, exit_live_message: str) -> str:
        ...
        return "\n".join(
            (name_line, start_date_line, elapsed_line, tags, f"\n[{exit_live_message}]")
        )
