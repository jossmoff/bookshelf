...
from test.utils.chapter_utils import (
    create_chapter_from_delta,
    create_in_progress_chapter,
)

STORY_NAME = "TEST_STORY"

SESSION_JSON = {"start_time": "2023-10-20T09:00:00", "end_time": "2023-10-20T10:30:00"}
...
def test_compute_duration_from_chapters():
    ...
    story = Story(
        STORY_NAME, datetime(2023, 1, 1, 10, 0), datetime(2023, 1, 1, 14, 0), chapters
    )
    assert_that(story.compute_elapsed_time_from_chapters()).is_equal_to(
        timedelta(hours=2)
    )
